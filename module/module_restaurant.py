...
result_path = file_path.replace(
    'module/module_restaurant.py', 'dictionary/QandA/restaurant-{}.txt').format(str(datetime.datetime.now()))
...
def restaurant(when):
    ...
    if when == "first":
        while True:
            ...
            setup_live_speech(False, order_dic_path, order_gram_path, 1e-20)
